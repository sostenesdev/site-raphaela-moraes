...
@section('content')
    <div class='card'>
        ...
        <div class='card-header'>
            <h3 class='mb-0'>{{isset($titulo)?'Listar '.$titulo.'s': 'Posts'}}</h3>
        </div>
        <!-- Card body -->
        <div class='card-body'>
            <div class='row'>
        ...
        $('#posts-table').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        let buttons =
                            '<a class="btn btn-sm btn-primary pl-2 pr-5" href="{{ route("admin.".$tipo_pagina.".edit") }}/' +
                            row.id + '"><i class="fa fa-pencil"></i></a>&nbsp;';
                        buttons = buttons +
                            '<a class="btn btn-sm btn-danger pl-2 pr-2" href="{{ route("admin.".$tipo_pagina.".delete") }}/' +
